...
exports.InitCharacterSchema1750436208361 = void 0;
class InitCharacterSchema1750436208361 {
    constructor() {
        this.name = 'InitCharacterSchema1750436208361';
    }
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "character_items_item" ("characterId" integer NOT NULL, "itemId" integer NOT NULL, CONSTRAINT "PK_63ce176a99c945bfe59fb92a4c5" PRIMARY KEY ("characterId", "itemId"))`);
        await queryRunner.query(`CREATE INDEX "IDX_f10171759b84a7e3c47219cb25" ON "character_items_item" ("characterId") `);
        await queryRunner.query(`CREATE INDEX "IDX_5937df225045a4185d0ecef35d" ON "character_items_item" ("itemId") `);
        ...
        await queryRunner.query(`ALTER TABLE "character_items_item" ADD CONSTRAINT "FK_f10171759b84a7e3c47219cb255" FOREIGN KEY ("characterId") REFERENCES "character"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "character_items_item" ADD CONSTRAINT "FK_5937df225045a4185d0ecef35d8" FOREIGN KEY ("itemId") REFERENCES "item"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
    }
    async down(queryRunner) {
        await queryRunner.query(`ALTER TABLE "character_items_item" DROP CONSTRAINT "FK_5937df225045a4185d0ecef35d8"`);
        await queryRunner.query(`ALTER TABLE "character_items_item" DROP CONSTRAINT "FK_f10171759b84a7e3c47219cb255"`);
        ...
        await queryRunner.query(`DROP TABLE "character_items_item"`);
        await queryRunner.query(`DROP TABLE "character"`);
        await queryRunner.query(`DROP TABLE "item"`);
        await queryRunner.query(`DROP TABLE "class"`);
    }
}
exports.InitCharacterSchema1750436208361 = InitCharacterSchema1750436208361;
